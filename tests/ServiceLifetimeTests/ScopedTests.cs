...
namespace Trendyol.Confluent.Kafka.Tests.ServiceLifetimeTests
{
    public class ScopedTests
    {
        ...
        [Test]
        public async Task GivenConsumerWithScopedService_ShouldConsumeMessages()
        {
            ...
            services.AddKafkaConsumer<ConsumerWithScopedField>(configuration =>
            {
            ...
            var consumerWithScopedField = serviceProvider.GetRequiredService<ConsumerWithScopedField>();
